...
class Constants {
    companion object {
        ...
        const val kExperiencePageType = "\"experience_pagetype\":"
        const val kExperienceWidgetType = "\"experience_widget\":"
        const val kAnalyticsIdentifier = "\"identifier\":"
        ...
        const val kRecsPageType = "pageType="
        const val kRecsPIDLabel = "&id="
        const val kRecsBrandLabel = "&brand="
        const val kRecsIPLabel = "&ip="
        const val kRecsWidgetLabel = "&widget="
